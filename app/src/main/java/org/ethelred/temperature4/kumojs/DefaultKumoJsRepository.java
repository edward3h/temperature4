...
@Singleton
public class DefaultKumoJsRepository implements KumoJsRepository {
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultKumoJsRepository.class);
    ...
    public DefaultKumoJsRepository(Configuration configuration, KumoService kumoService) {
